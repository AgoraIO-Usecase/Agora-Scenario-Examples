...
public class Constants {
    ...
    public static final String AGORA_CDN_CHANNEL_PUSH_PREFIX = "rtmp://examplepush.agoramde.agoraio.cn/live/%s";
    public static final String AGORA_CDN_CHANNEL_PULL_PREFIX = "http://examplepull.agoramde.agoraio.cn/live/%s.flv";
    ...
    public static CameraCapturerConfiguration.CAMERA_DIRECTION currCameraDirection = CameraCapturerConfiguration.CAMERA_DIRECTION.CAMERA_FRONT;
