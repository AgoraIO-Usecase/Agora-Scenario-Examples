...
public class RoomManager {
    ...
    /// 房间内用户列表
    private static final String SYNC_SCENE_ROOM_USER_COLLECTION = "userCollection";
    ...
    public void init(Context context, String appId, DataCallback<Exception> error) {
        ...
        params.put("defaultChannel", "SmallClass");
    ...
    public void loginLocalUser(String roomId) {
        checkInitialized();
        SceneReference sceneReference = sceneMap.get(roomId);
        if (sceneReference == null) {
            return;
