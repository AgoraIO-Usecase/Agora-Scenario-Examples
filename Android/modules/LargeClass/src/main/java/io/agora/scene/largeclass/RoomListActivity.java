...
public class RoomListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.large_class_room_list_activity);
        StatusBarUtil.hideStatusBar(getWindow(), false);

        runOnUiThread(() -> RoomManager.getInstance().init(RoomListActivity.this, getString(R.string.sync_app_id), data -> {
        ...
        titleBar.setTitleName(!TextUtils.isEmpty(getIntent().getStringExtra("label"))? getIntent().getStringExtra("label"):getResources().getString(R.string.large_class_app_name), 0);
