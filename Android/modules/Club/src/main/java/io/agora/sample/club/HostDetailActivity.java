...
import io.agora.sample.club.databinding.ClubHostDetailActivityBinding;
...
public class HostDetailActivity extends AppCompatActivity {
    ...
    private ClubHostDetailActivityBinding mBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = ClubHostDetailActivityBinding.inflate(LayoutInflater.from(this));
