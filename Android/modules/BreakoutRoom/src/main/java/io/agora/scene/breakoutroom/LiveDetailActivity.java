...
public class LiveDetailActivity extends AppCompatActivity {
    ...
    private void joinChannel(String roomId) {
        ...
        TokenGenerator.gen(this, channelName, localUid, ret -> rtcEngine.joinChannel(ret, channelName, "", localUid));
    }
    ...
    private void renderLocalPreview() {
        ...
        mBinding.dynamicViewFgRoom.dynamicAddView(videoItemBinding.getRoot());
        rtcEngine.setupLocalVideo(new VideoCanvas(videoItemBinding.videoTextureview, Constants.RENDER_MODE_HIDDEN, 0));
