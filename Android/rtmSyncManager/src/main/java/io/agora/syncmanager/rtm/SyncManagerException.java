...
public class SyncManagerException extends Exception {
    ...
    public SyncManagerException(int theCode, String theMessage) {
        super(theMessage);
        this.code = theCode;
    }

    public SyncManagerException(String message, Throwable cause) {
        super(message, cause);
            this.code = ERROR_DEFAULT;
    }

    public SyncManagerException(Throwable cause) {
        super(cause);
            this.code = ERROR_DEFAULT;
    }
