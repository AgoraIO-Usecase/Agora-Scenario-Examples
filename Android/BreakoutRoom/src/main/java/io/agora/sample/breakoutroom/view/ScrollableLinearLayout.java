package io.agora.sample.breakoutroom.view;
...
public class ScrollableLinearLayout extends LinearLayoutCompat {
    ...
    public ScrollableLinearLayout(Context context, @Nullable AttributeSet attrs) {
...
//        if (currentDirection == -1) return;
    ...
    public void attachToIndicator(IndicatorView indicatorView) {
