...
import io.agora.sample.rtegame.databinding.DialogGameModeBinding;
import io.agora.sample.rtegame.util.GameUtil;

public class GameModeDialog extends BaseBottomSheetDialogFragment<DialogGameModeBinding> implements OnItemClickListener<RoomInfo> {
