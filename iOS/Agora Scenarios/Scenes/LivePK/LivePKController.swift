...
class LivePKController: BaseViewController {
    ...
    private func updatePKUIStatus(isStart: Bool) {
        ...
        if isStart {
            ...
            timer.scheduledTimer(withName: SceneType.pkApply.rawValue, timeInterval: 3600, queue: .main) { [weak self] _, duration in
...
extension LivePKController: AgoraRtcChannelDelegate {
